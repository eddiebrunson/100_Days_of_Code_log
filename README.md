...
**Thoughts:** Today, I continued working throught project 2. I'm almost ready to turn it in. Tomorrow and this weekend I plan to finish my TODO app and Cloud Dev Nanodegree. 
...
- Continue Introduction to Machine Learning with AWS
...
**Thoughts:** Today, is the last day of access to the Intro to Machine learning with AWS material! I'm so glad I stuck with this material! I have learned so much and cannot wait to continue learning more about this topic! I believe I will be getting a certification for completing this Nanodegree! So, I look forward to that! I also continued working on troubleshooting the TODO app. I'm still stuck getting the delete to work correctly. I'm also working on getting the image upload to work correctly. Hopefully, I will figure it out soon!  
...
**Thoughts:** Almost finished with the Intro to Machine Learning material! I decided not to do the exercises to save myself from AWS charges. So instead watched the step by step instructions on how to use DeepComposer. I'm so glad I stuck with this material, because it is starting to make a lot of sence! 
...
**Thoughts:** Continued working through the Intro to Machine Learning material! Learning so much about DeepComposer and Generative AI! Exciting stuff! 
...
**Thoughts:** Another milestone is coming to an end! The Intro to Machine Learning Nanodegree ends on the 31st of July, 2020. So I'm trying to finish up the material and atttempt to study for the end of course assement. If I score in the top 320 I will be able to enroll in the new Machine Learning with Azure Nanodegree! Although, I found out about this scholarship a month late. So 4 weeks doesn't seem like enough time for me to dig in to the material. Nonetheless, I will try! 
...
**Thoughts:** Even though I paused workng on my React Nanodegree. Today, I updated some critical security issues on github regarding my React projects. I also continued working on the SuperDuperDrive app and the TODO app. 
...
**Thoughts:** Today, I continued troubleshooting my TODO app. I fixed my headers in my lambda functions. Now I do not get a 400 status code. Although, I still need to fix the delete functionality. As it only deletes after refreshing the browser. 
...
**Thoughts:** Today I got past the Type attribute error! So I can now login to my Todo app without an error, but when I create a todo. I get a status code of 400! So I believe its something to do with my auth headers again. I'm so close! This has been a long process of troubleshooting! 
...
**Thoughts:** Today I continued working on the SuperDuperDrive project. So far so good!
...
- Working on TODO App Cloud Development Project 
- Continue working on DevOps Deploy Static Website. 
- Setup for SuperDuperDrive Project - Java 

**Progress:**

- Finished Setting up SuperDuperDrive Project - Java
- Finished configuring AWS services for the DevOps project
- Finished setting up my local development environment for the project
_ Resolved AWS billing issue
- Read [React Docs](https://reactjs.org/docs/getting-started.html)
...
**Thoughts:** Today I worked on my first Java Project. I'm learning so much about the syntax and overall web development process as it relates to Java. 
